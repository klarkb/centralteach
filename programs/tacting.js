...
function setupDoneButtonHandler(modal) {
    ...
    newDoneButton.addEventListener('click', () => {
        ...
        console.log('Creating Tacting / Rec. ID program with stimuli:', selectedStimuli.length, 'target:', targetStimulus?.alt);
        ...
        setTimeout(() => {
            ...
            modal.querySelectorAll('.icon-item.selected, .icon-item.target').forEach(item => {
...
function setupTargetSelectionHandler(modal) {
    ...
    selectTargetButton.parentNode.replaceChild(newSelectTargetButton, selectTargetButton);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setTimeout(() => {
        ...
        const tactingProgramItem = Array.from(document.querySelectorAll('.program-item'))
            .find(item => {
    ...
    if (tactingProgramItem) {
        ...
        tactingProgramItem.parentNode.replaceChild(newTactingItem, tactingProgramItem);
        ...
        console.log('Testing modal function availability:', typeof openTactingModal);
        
    } else {
        console.error('Could not find Tacting / Rec. ID program item in the sidebar');
